...
abstract class $ProductsCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String nama, int harga});
}
...
class _$ProductsImpl implements _Products {
  _$ProductsImpl({this.id = 0, this.nama = '', this.harga = 0});
  ...
  @override
  String toString() {
    return 'Products(id: $id, nama: $nama, harga: $harga)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, nama, harga);
...
abstract class _Products implements Products {
  factory _Products({final int id, final String nama, final int harga}) =
      _$ProductsImpl;
