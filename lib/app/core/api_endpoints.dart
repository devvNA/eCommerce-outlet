// MARVELINDO
// const baseUrl = 'http://192.168.217.205:8000/api'; // IP REAL DEVICE
// const baseUrl = 'http://10.212.39.184:8000/api'; // IP EMU
const baseUrl = 'http://scm8.satriatech.com/api';
const listProduk = "/admin/products";
const listProdukByCategory = "/admin/productsbytype";
const listKeranjang = "/admin/getkeranjang";
const deleteKeranjang = "/admin/deleteitemkeranjang";
const postKeranjang = "/admin/additemkeranjang";
const updateKeranjang = "/admin/updateitemkeranjang";
const checkout = "/admin/transaksi";
const listHistoryPemesanan = "/admin/gettransaksi";
const getUserLink = "/admin/user-data";
const uploadBukti = "/admin/uploadbukti";
const refreshTokenUrl = "/admin/refresh-token";
const loginUrl = "/login";
const logoutUrl = "/logout";
const registerUser = "/register";
const listKategori = "/admin/productstype";
